import { RpcProvider, Account, Contract, GetTxReceiptResponseWithoutHelper } from 'starknet';
...
declare class ContractManager {
     ...
     */
    executeTransaction(contract: Contract | string, functionName: string, args?: any[], bufferPercentage?: number): Promise<string>;
    /**
     ...
     */
    estimateMaxFee(contract: Contract, functionName: string, functionArgs: any[], bufferPercentage: number): Promise<bigint>;
